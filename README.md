...
Your code loads a dataset from:
...
matplotlib → plotting confusion matrix and ROC curve

numpy → numerical operations

The README lists these to show what tools are needed to run the project.
...
Any Python project requires instructions so other people know:
